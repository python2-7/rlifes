...
def reduceTree (user):
    ...
    tree = {
        "id":user.customer_id,
        "fullname":str(user.fullname.encode('utf-8')),
        "email":user.email,
...
def children_tree (json):
    ...
    if user_p_left is not None:
        ...
        tree = {
            ...
            "fullname":str(user_p_left.fullname.encode('utf-8')),
            "email":str(user_p_left.email.encode('utf-8')),
            "investment":user_p_left.investment,
