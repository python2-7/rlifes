...
def reduceTree (user):
    ...
    tree = {
        ...
        "level":levelss,
        "active":user.active,
        "leftPD":format_usd(user.total_left),
        "rightPD":format_usd(user.total_right),
        "count_left":format_usd(user.count_left),
        "count_right":format_usd(user.count_right),
...
def children_tree (json):
    ...
    if user_p_left is not None:
        ...
        if user_sponser_left is not None:
        ...
        tree = {
            ...
            "name":str(user_p_left.name.encode('utf-8')),
            "username":str(user_p_left.username.encode('utf-8')),
            "email":str(user_p_left.email.encode('utf-8')),
            "active":user_p_left.active,
            "date_added":format_date(user_p_left.creation),
            "level":levelss_left,
            "level_user":"Null",
            "leftPD":format_usd(user_p_left.total_left),
            "rightPD":format_usd(user_p_left.total_right),
            "count_left":format_usd(user_p_left.count_left),
            "count_right":format_usd(user_p_left.count_right),
            "sponsor": sponsor,
            "empty":False,
            "iconCls":"level2 left",
            "status" : 1,
    ...
    if user_p_right is not None:
        ...
        if user_sponser_right is not None:
        ...
        tree = {
            ...
            "name":str(user_p_right.name.encode('utf-8')),
            ...
            "active":user_p_right.active,
            "level":levelss_right,
            "level_user":"Null",
            "leftPD":format_usd(user_p_right.total_left),
            "rightPD":format_usd(user_p_right.total_right),
            "count_left":format_usd(user_p_right.count_left),
            "count_right":format_usd(user_p_right.count_right),
            "sponsor":sponsor,
            "empty":False,
